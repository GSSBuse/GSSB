...
public class ImgCompress {  
	  private int width;
	    ...
	    public static void main(String[] args) {
	    	ImgCompress is = new ImgCompress();
	        try {
	        	InputStream fromFileInputStream = new BufferedInputStream(new FileInputStream("E:/Koala.jpg"));
	            is.saveImageAsJpg(fromFileInputStream, "E:/Koala1.jpg", 400, 120);
	        } catch (Exception e) {
	            e.printStackTrace();
	        }
	    }
	    ...
	    // fromFileInputStream原图片输入流,saveToFileStr生成缩略图地址,formatWideth生成图片宽度,formatHeight高度
	    public void saveImageAsJpg(InputStream fromFileInputStream, String saveToFileStr,
	            int formatWideth, int formatHeight) throws Exception {
	        BufferedImage srcImage;
	        File saveFile = new File(saveToFileStr);
	        srcImage = javax.imageio.ImageIO.read(fromFileInputStream); // construct image
	        int imageWideth = srcImage.getWidth(null);
	        int imageHeight = srcImage.getHeight(null);
	        int changeToWideth = 0;
	        int changeToHeight = 0;
