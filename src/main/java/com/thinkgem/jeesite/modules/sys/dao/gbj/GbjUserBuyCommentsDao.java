...
public interface GbjUserBuyCommentsDao extends CrudDao<GbjUserBuyComments> {
	...
	//
	public List<GbjUserBuyComments> findDomainArticleBuyCommentsList(String id);

	public List<GbjUserBuyComments> findDomainArticleBuyReplyCommentsList(String id);
}