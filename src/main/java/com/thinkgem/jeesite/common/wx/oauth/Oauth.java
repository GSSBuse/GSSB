...
public class Oauth {
    ...
    private static final String QY_TOKEN_URI = "https://qyapi.weixin.qq.com/cgi-bin/gettoken";
...
//    }
     ...
     * @throws UnsupportedEncodingException 
     */
    public String getCodeUserInfo(String redirect_uri) throws UnsupportedEncodingException {
        Map<String, String> params = new HashMap<String, String>();
        params.put("appid", getAppid());
        params.put("response_type", "code");
        params.put("redirect_uri", redirect_uri);
    ...
    public String getToken() throws Exception {
        Map<String, String> params = new HashMap<String, String>();
        params.put("corpid", getAppid());
        params.put("corpsecret", getSecret());
        //params.put("code", code);
        //params.put("grant_type", "authorization_code");
        return HttpKit.get(QY_TOKEN_URI, params);
    }
