...
public class Qrcod {
	 ...
	 * @throws IOException
	 */
	public Object createScene(String accessToken, int expireSeconds,
		...
		String post = Json.toJson(params);
	 ...
	 * @throws IOException
	 */
	public Object createLimitScene(String accessToken, int sceneId)
