...
<body ontouchstart="" class="ms-loader ms-loading">
	<div class="page-wrapper">
		<!-- 安全设置导航begin -->
		<div data-title="设置支付密码" class="page active ms-controller" ms-controller="addPayPassword" id="addPayPassword">
			<section class="ui-container">
				<div class="pay-pass">
					<p class="tip" id="tip">请设置支付密码，建议勿与银行卡取卡取款密码相同</p>
					...
					<p class="feedback"></p>
					<input type="tel" name="oldpaypass" id="oldpaypass" value="">
					<input type="tel" name="paypass" id="paypass" value="">
					<input type="tel" name="confirmpaypass" id="confirmpaypass" value="">
				</div>
			</section>
			<!-- 支付密码键盘 -->
			...
			<script type="text/javascript" data-page="addPayPassword"></script>
		</div>
	</div>
