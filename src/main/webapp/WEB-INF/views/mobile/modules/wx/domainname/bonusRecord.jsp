...
<body ontouchstart="" class="ms-loader ms-loading">
	<div class="page-wrapper">
		...
		<div data-title="领红包记录" class="page active ms-controller" ms-controller="bonusRecord" id="bonusRecord">
				...
				<ul class="ui-list ui-list-text ui-border-tb">
					<li class="ui-border-t">
						<div class="ui-list-info" style="padding-right:0px;">
							<div class="ui-nowrap redbag-list-first"><b>通过以下域名领取了红包：</b></div>
						</div>
					...
					<li class="ui-border-t">
						<div class="ui-list-info" style="text-align:left;width:33%;">
							<ul class="ui-row">
								...
								<!-- <div class="ui-txt-warning">{{del.clientName}}所发</div> -->	
								</li>
							</ul>
						</div>
				  <!-- <div class="ui-list-info" style="text-align:center;width:33%;">
							<h4 class="ui-nowrap">{{del.createDate}}</h4>
						</div> -->
						<div style="text-align:right;width:33%;">
						<ul class="ui-row">
								<li class="ui-col">
									<h4 class="ui-nowrap" style="font-size:12px;"><b>{{del.type}}</b></h4>
									<div class="ui-txt-warning" style="font-size:12px;">{{del.money/100.00}}元</div>
								</li>
							</ul>
						</div> 
					</li>
				</ul>
				<!--<div class="ui-btn-wrap" style="padding: 10px 0px;" ms-if="clientId=='clientId_null'">
					<button class="ui-btn-lg ui-btn-primary" ms-click="share">分享</button>
					<br>
					<button class="ui-btn-lg ui-btn-primary" id="btn-share" onclick="history.back()">返回</button>
				</div>  -->
			</section>
		  	<div id="directiveDivBonus" class="ui-dialog share-arrow">
		  		<img class="share-arrow-image" src="${pageContext.request.contextPath}/static/images/share-arrow.png">
		  	</div>
			<script type="text/javascript" data-page="bonusRecord"></script>
		</div>
	</div>
