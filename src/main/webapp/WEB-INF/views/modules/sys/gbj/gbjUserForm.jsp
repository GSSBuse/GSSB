...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/sys/gbj/gbjUser/">用户信息增删改查列表</a></li>
		<li class="active"><a href="${ctx}/sys/gbj/gbjUser/form?id=${gbjUser.id}">用户信息增删改查<shiro:hasPermission name="sys:gbj:gbjUser:edit">${not empty gbjUser.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="sys:gbj:gbjUser:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="gbjUser" action="${ctx}/sys/gbj/gbjUser/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<div class="form-actions">
			<shiro:hasPermission name="sys:gbj:gbjUser:edit"><input id="btnSubmit" class="btn btn-primary" type="submit" value="保 存"/>&nbsp;</shiro:hasPermission>
