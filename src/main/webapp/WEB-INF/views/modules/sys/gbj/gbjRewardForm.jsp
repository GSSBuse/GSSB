...
<body>
	<ul class="nav nav-tabs">
		...
		<li class="active"><a id="insertOrUpdate" href="${ctx}/sys/gbj/gbjReward/form?id=${gbjReward.id}">悬赏信息管理<shiro:hasPermission name="sys:gbj:gbjReward:edit">${not empty gbjReward.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="sys:gbj:gbjReward:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="gbjReward" action="${ctx}/sys/gbj/gbjReward/save" method="post" class="form-horizontal">
		...
		<div class="control-group" style="visibility:hidden">
			...
			<div class="controls">
				<form:input path="user.id" id="userIdInput" readonly="true"  htmlEscape="false" maxlength="64" class="input-xlarge required"/>
		...
		<div class="control-group" id="userNameDiv">
			...
			<div class="controls">
				<form:input path="user.username" id="userNameInput" readonly="true"  htmlEscape="false" maxlength="64" class="input-xlarge required"/>
				<span class="help-inline"><font color="red">*</font> </span>
			</div>
		</div>
