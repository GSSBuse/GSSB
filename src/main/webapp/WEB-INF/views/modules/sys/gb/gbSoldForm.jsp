...
<body>
	...
	<form:form id="inputForm" modelAttribute="gbSold" action="${ctx}/sys/gb/gbSold/save" method="post" class="form-horizontal">
		...
		<div class="control-group">
			<label class="control-label">type_id：</label>
			<div class="controls">
				<form:input path="typeId" htmlEscape="false" maxlength="10" class="input-xlarge "/>
			</div>
		</div>
		<div class="control-group">
		...
		<div class="control-group">
			<label class="control-label">realprice：</label>
			<div class="controls">
				<form:input path="realprice" htmlEscape="false" maxlength="20" class="input-xlarge  digits"/>
			</div>
		</div>
		<div class="control-group">
			<label class="control-label">connacts：</label>
			<div class="controls">
				<form:input path="connacts" htmlEscape="false" maxlength="50" class="input-xlarge "/>
			</div>
		</div>
		<div class="control-group">
