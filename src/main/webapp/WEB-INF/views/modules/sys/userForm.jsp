...
<body>
	...
	<form:form id="inputForm" modelAttribute="user" action="${ctx}/sys/user/save" method="post" class="form-horizontal">
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:input path="wechat" htmlEscape="false" maxlength="100"/>
			</div>
		</div>
		<div class="control-group">
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:input path="nickName" htmlEscape="false" maxlength="100"/>
			</div>
		</div>
		<div class="control-group">
			<label class="control-label">微信客服账号:</label>
			<div class="controls">
				<form:input path="kfAccount" htmlEscape="false" maxlength="255"/>
			</div>
		</div>
		<div class="control-group">
