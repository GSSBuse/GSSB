			...
			<div class="row">
				...
				<div class="menuB">
					<div class="one" style="display: block;">
						<p>商标注册人可以通过签订商标使用许可合同，许可他人使用其注册商标。商标使用许可合同应当到商标局备案。</p>
						<article>
							<p>
								<span>《商标法》第四十条规定</span>：“&nbsp;商标注册人可以通过签订商标使用许可合同，许可他人使用其注册商标。……商标使用许可合同应当报商标局备案。”
								<br><br><span>《商标法实施条例》第四十三条规定</span>：“&nbsp;许可他人使用其注册商标的，许可人应当自商标使用许可合同签订之日起3个月内将合同副本报送商标局备案。”
							</p>
