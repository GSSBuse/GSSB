				...
				<div class="menuB">
					<div class="one" style="display: block;">
						<article>
							...
							<h2>什么是行政诉讼？</h2>
							<p>商标行政诉讼主要是指在商标管理过程中受到工商行政管理部门的具体行政行为处理的公民、法人 或非法人其他组织，对处理不服并依据《商标法》及《行政诉讼法》有关规定向人民法院起诉，人 民法院在双方当事人及其他诉讼参与人的参加下，对商标行政案件受理、审理、裁判以及执行活动 的总称，是由司法机关解决商标行政争议的一种法律活动。</p>
							<p>商标确权行政诉讼主要包括对商标评审委员会异议复审裁定、争议裁定、驳回复审决定、撤销复审 裁定等不服，依法向人民法院起诉或者依法参与人民法院审判的活动。</p>
							<h2>行政诉讼必要性：</h2>
							<span class="ll1">01</span>商标确权行政诉讼是当事人争取改变商标评审委员会对自身做出不利裁定的唯一法律救济途径。<br> <br>
							<span class="ll1">02</span>重要商标遭遇不利裁定结果时，只要有一线希望，大多数当事人都会选择权利用尽进行争取。<br>
					...
					<div class="one">
						<img
							src="http://www.shangbiaozongju.com/userfiles/20140629143132197.png">
					</div>
					<div class="one">
