			...
			<div class="row">
				...
				<div class="menuB">
					<div class="one" style="display: block;">
						<p>商标核准注册后，商标注册人的名义、地址或其他注册事项发生变更的，应当向商标局申请办理相应变更手续。</p>
						<article>
							<p>
								<span>&nbsp;变更商标注册人名义或地址的，商标注册人应将其全部注册商标一并变更。
								<br><br>&nbsp;若有他人申请贵公司商标三年停止使用而对您的商标提出撤消申请， 商标局所有相关的商标文件都会通过商标注册证书上的地址邮寄给您，如由于未及时 向商标局申请变更名义或地址，商标局的文件将不能送达给您，您的商标有可能因此 而被撤消（已有大量因此原因商标被撤的先例）。
								</span>
							</p>

							<p>商标使用许可在绝大多数情况下是一个双赢行为。对许可方来说，可以不必扩大投资即可增加产量和辐射面，扩大市场占有率，进一步提高商标的知名度并获得收益；对于被许可方来说，使用他人已有较高知名度的商标能扩大商
								品销售，增加效益与发展。</p>
							<p>除此之外，商标使用许可合同的备案主要是为起到公示的作用，方便他人查阅。若没有进行许可备案的，将不得对抗善意第三人。所以建议您及时办理商标许可备案登记，以便保护合同双方的权益。</p>
						</article>
						<p style="margin: 0px; padding: 0px;">&nbsp;</p>
						<img src="http://www.shangbiaozongju.com/images/sbzc3.png">
						<img src="http://www.shangbiaozongju.com/images/sbzc2.png">
					</div>
					<div class="one">
						<img src="http://www.shangbiaozongju.com/images/sbzc1.png">
						<table width="100%" cellspacing="1" cellpadding="0" border="0"
							align="center">
							<tbody>
								<tr id="th">
									<th width="10%">序号</th>
									<th colspan="2" width="30%">收费项目</th>
									<th width="30%">统一含税价</th>
									<th width="30%">备注</th>
								</tr>
								<tr>
									<td>1</td>
									<td colspan="2">国内商品/服务商标注册</td>
									<td>2500</td>
									<td>申报10个商品/服务项目以上，210元/个</td>
								</tr>
								<tr style="background: rgb(238, 238, 238);">
									<td>2</td>
									<td colspan="2">国外到国内的商品/服务商标注册</td>
									<td>面议</td>
									<td>/</td>
								</tr>
								<tr>
									<td>3</td>
									<td colspan="2">集体、证明商标注册申请</td>
									<td>8500起</td>
									<td>如需我方拟订具体材料，费用另起</td>
								</tr>
								<tr style="background: rgb(238, 238, 238);">
									<td>4</td>
									<td colspan="2">商标续展注册申请</td>
									<td>3500</td>
									<td>/</td>
								</tr>
								<tr>
									<td>5</td>
									<td colspan="2">商标续展注册延期</td>
									<td>4000</td>
									<td>/</td>
								</tr>
								<tr style="background: rgb(238, 238, 238);">
									<td>6</td>
									<td colspan="2">商标转让注册申请</td>
									<td>2500</td>
									<td>/</td>
								</tr>
								<tr>
									<td>7</td>
									<td colspan="2">商标使用许可合同备案</td>
									<td>1500</td>
									<td>/</td>
								</tr>
								<tr style="background: rgb(238, 238, 238);">
									<td>8</td>
									<td colspan="2">变更注册人名义/地址</td>
									<td>2000</td>
									<td>/</td>
								</tr>
								<tr>
									<td>9</td>
									<td colspan="2">补发商标注册证书</td>
									<td>2500</td>
									<td>/</td>
								</tr>
								<tr style="background: rgb(238, 238, 238);">
									<td>10</td>
									<td colspan="2">代领商标局、商评委官方文件</td>
									<td>400</td>
									<td>/</td>
								</tr>
								<tr>
									<td>11</td>
									<td colspan="2">商标设计</td>
									<td>5000</td>
									<td>直至客户满意为止</td>
								</tr>
								<tr style="background: rgb(238, 238, 238);">
									<td>12</td>
									<td colspan="2">商标取名</td>
									<td>1000起</td>
									<td>直至客户满意为止</td>
								</tr>
								<tr>
									<td>13</td>
									<td colspan="2">商标更正</td>
									<td>1500</td>
									<td>/</td>
								</tr>
								<tr style="background: rgb(238, 238, 238);">
									<td>14</td>
									<td colspan="2">提供商标注册证明</td>
									<td>1000</td>
									<td>/</td>
								</tr>
								<tr>
									<td>15</td>
									<td colspan="2">补发变更、续展、转让证明</td>
									<td>1000</td>
									<td>/</td>
								</tr>
								<tr style="background: rgb(238, 238, 238);">
									<td>16</td>
									<td colspan="2">撤回商标注册申请（撤销连续三年不使用、商标异议、商标评审等）申请</td>
									<td>1000</td>
									<td>/</td>
								</tr>
								<tr>
									<td>17</td>
									<td colspan="2">撤回商标转让申请</td>
									<td>1500</td>
									<td>/</td>
								</tr>
								<tr style="background: rgb(238, 238, 238);">
									<td>18</td>
									<td colspan="2">变更商标申请代理人</td>
									<td>1500</td>
									<td>/</td>
								</tr>
								<tr>
									<td>19</td>
									<td colspan="2">商标许可备案变更</td>
									<td>1500</td>
									<td>/</td>
								</tr>
								<tr style="background: rgb(238, 238, 238);">
									<td>20</td>
									<td colspan="2">删减商品/服务项目</td>
									<td>1500</td>
									<td>/</td>
								</tr>
								<tr>
									<td>21</td>
									<td colspan="2">商标注销申请</td>
									<td>500</td>
									<td>/</td>
								</tr>
								<tr style="background: rgb(238, 238, 238);">
									<td>22</td>
									<td colspan="2">注册人死亡/终止注销申请</td>
									<td>1000</td>
									<td>/</td>
								</tr>
								<tr>
									<td rowspan="2">23</td>
									<td rowspan="2">著作权登记</td>
									<td>美术作品</td>
									<td>4000-6000</td>
									<td rowspan="2">如需办理加急，视加急时间不同收费</td>
								</tr>
								<tr style="background: rgb(238, 238, 238);">
									<td>计算机软件</td>
									<td>3500-6000</td>
								...
								<tr>
									<td rowspan="3">24</td>
									<td rowspan="3">商标查询</td>
									<td>中文</td>
									<td>150</td>
									<td rowspan="3">由专业人员出具书面查询报告并附相关引证商标档案</td>
								</tr>
								<tr style="background: rgb(238, 238, 238);">
									<td>英文</td>
									<td>300</td>
					...
					<div class="one">
						...
						<p style="text-align: center; margin-top: 10px;">
							<img src="http://www.shangbiaozongju.com/images/sbys1.jpg"
								style="width: 680px;">
						</p>
						<p style="text-align: center;">
							<img src="http://www.shangbiaozongju.com/images/sbys2.jpg"
								style="width: 680px;">
						</p>
						<p style="text-align: center;">
							<img src="http://www.shangbiaozongju.com/images/sbys3.jpg"
								style="width: 680px;">
						</p>
						<p style="text-align: center;">
							<img src="http://www.shangbiaozongju.com/images/sbys4.jpg"
								style="width: 680px;">
						</p>
						<p style="text-align: center;">
							<img src="http://www.shangbiaozongju.com/images/sbys5.jpg"
								style="width: 680px;">
						</p>
