				...
				<div class="span8 page-content">
					...
					<div class="menuB">
						<div class="one" style="display: block;">
							...
							<article>
								<p>
									<span>&nbsp;变更商标注册人名义或地址的，商标注册人应将其全部注册商标一并变更。 <br>
									<br>&nbsp;若有他人申请贵公司商标三年停止使用而对您的商标提出撤消申请，
										商标局所有相关的商标文件都会通过商标注册证书上的地址邮寄给您，如由于未及时
										向商标局申请变更名义或地址，商标局的文件将不能送达给您，您的商标有可能因此 而被撤消（已有大量因此原因商标被撤的先例）。
									</span>
								</p>
