			...
			<div class="row">
				...
				<div class="menuB">
					<div class="one" style="display: block;">
						<article>
							<p>非洲知识产权组织（简称OAPI或非知）是由前法国殖民地、官方语言为法语的国
								家组成的区域性知识产权保护联盟，商标核准注册后在16个成员国均受保护，有效期
								10年。该组织在喀麦隆设有知识产权办公室，统管各成员国的商标事务。各成员国在
								商标领域内受非洲知识产权组织的约束，没有各自独立的商标制度，所以在各个国家
								并不存在逐一国家注册的可能性，只能通过非洲知识产权组织统一注册保护。</p>
							<p>16个成员国为：喀麦隆、贝宁、布基纳法索、中非共和国、刚果（布）、乍得、加蓬、几内亚、几内亚比绍、科特迪瓦（象牙海岸）、马里、毛里坦尼亚、尼日尔、塞内加尔、多哥、赤道几内亚。
							</p>
							<p class="qo">更多介绍请见OAPI官网：</p>
							<a href="http://www.oapi.int/index.php"><span
								style="color: rgb(0, 0, 255); font-size: 10.5pt; font-family: 微软雅黑;">http://www.oapi.int/index.php</span></a>
						</article>
					</div>
					<div class="one">
					</div>
