				...
				<div class="menuB">
					<div class="one" style="display: block;">
						<article>
							...
							<h2>什么是著名商标？</h2>
							<p>著名商标是商标权利人或者商标的被许可使用人依据各地《著名商标认定和保护条例》向当地的工 商行政管理部门申请认定“著名商标”，工商行政管理机关依法对满足条件的商标认定为“著名商标”的行政程序。 全国各地对认定著名商标的条件各不相同，但一般都要求企业的经济效益和经济规模在当地行业内 处于领先地位。企业的商标如果被认定为著名商标，不仅企业的商标专用权可以在当地受到高于普 通商标的保护，还能表明企业的经营状况和产品质量较一般企业更具优势，对企业提高产品在市场 上的竞争力有极大的促进作用。。</p>

							<h2>著名商标必要性：</h2>
							<span class="ll1">01</span>著名商标能够得到比普通商标力度更大 的特殊保护： 著名商标认定后不但能够使商标在非类似商品上得到一定保护，还能够扩大保护到企业的字号权以及商品包装。<br> <br>
							<span class="ll1">02</span>著名商标认定后不但将提高产品的信任 度，也能够提升品牌价值： 使用著名商标的产品或者服务代表着更 高的品质和信誉，更容易使消费者信任； 同时，著名商标认定也代表着企业品牌 影响力的提升和无形资产价值的增长。<br>
							<br> <span class="ll1">03</span>为争创驰名商标创造必要条件： 著名商标认定后将为日后申报中国驰名 商标奠定充实基础，大部分中国驰名商 标在认定前均已被评为当地著名商标。 04、著名商标认定后可以获得政府的资金奖 励： 各地政府为鼓励企业将品牌做大做强， 均会出台政策鼓励企业申报著名商标， 因此企业认定著名不但有利于企业发 展，还能够直接获得资金奖励。<br>

						</article>
					</div>
					<div class="one">
						<img
							src="http://www.shangbiaozongju.com/userfiles/20140630021012169.png">
					</div>
					<div class="one">
