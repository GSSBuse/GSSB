...
<script type="text/javascript" src="${ctxStatic }/front/js/soldcomments.js"></script>
<script type="text/javascript" src="${ctxStatic }/front/js/soldreplycomments.js"></script>
<script type="text/javascript"
	src="${ctxStatic }/front/js/soldupcounts.js"></script>
<body ms-controller="articles">
	<%@ include file="/WEB-INF/views/include/frontTopMenu.jsp"%>
	<div class="about">
		<div class="container">
			<h1>
				卖标信息<span class="m_1"><br>最新发布的卖标信息，如有兴趣请联系123456789</span>
			</h1>
		</div>
	</div>
				...
				<div class="span8 page-content">
					<article class=" type-post format-standard hentry clearfix">
						...
						<div class="post-meta clearfix like-btn" ms-controller="upcounts">
							<span id="time" class="date">${gbjSoldDetail.createDate}</span> <span class="category"><a
								href="#" class="gbjType">${gbjSoldDetail.typeId}</a></span> 
							<span class="comments">浏览次数：<a
								href="#">${gbjSoldDetail.lookCounts}</a></span>
					...
					<section id="comments">
						...
						<ol class="commentlist"
							ms-repeat-ell="datas.domainSoldCommentsArticleList">
							...
							<li class="comment even thread-even depth-1" id="li-comment-2">
								...
								<!-- end of comment -->
								 <ul  class="children" ms-repeat-data="datas.domainSoldReplyCommentsArticleList" >
	...
	<div id="reply-dialog"  style="position: fixed; background: rgb(249, 249, 249); top: 50%; left: 50%; transform: translate(-50%, -50%); z-index: 10; display: none;">
		<div id="close-dialog1" style="position: absolute; right: -10px; top: -14px; width: 24px; height: 24px; text-align: center; font-size: 25px; border: 2px solid #d2d1d1; border-radius: 50%; background-color: #fff; color: #e71a1a; cursor: pointer;">×</div>
		        <form method="post" id="replyform" >
								...
								<div>
									<label for="comment"></label> 
									<input name="soldId" type="hidden" id="soldId"
										value="${gbjSoldDetail.id}">
								...
								<div>
									<input class="btn" onclick="soldreplySubmit();" name="submit" type="button" id="submit" value="提交评论" style="float: right; margin-right: 20px; margin-bottom: 12px;     margin-top: 12px;">
								</div>
							</form>
	</div>
