					...
					<div class="menuB">
						<div class="one" style="display: block;">
							<article>
								...
								<p>
									是指通过欧盟下属的内部市场协调局在欧盟所有国家统一申请注册保护的注册方式。由于欧盟是一个统一的市场，所以商标获得“欧盟（也称欧共体）”注册后，将在欧盟各个成员国受到保护。目前，欧盟成员国共有28个。</p>
								<p>28个成员国包括：奥地利、法国、意大利、西班牙、比利时、德国、卢森堡、瑞典、
									丹麦、希腊、荷兰、英国、芬兰、爱尔兰、葡萄牙、匈牙利、波兰、捷克、斯洛文尼亚、 斯洛伐克、爱沙尼亚、立陶宛、马耳他、塞浦路斯、
									拉脱维亚、保加利亚、罗马尼亚、克罗地亚。</p>
								<a href="http://www.registerbrandeurope.cn/"><span
									style="color: rgb(0, 0, 255); font-size: 10.5pt; font-family: 微软雅黑;">http://www.registerbrandeurope.cn/</span></a>
								<img
									src="http://www.shangbiaozongju.com/userfiles/20140622084747163.png">
							</article>
						</div>
						<div class="one">
							<img
								src="http://www.shangbiaozongju.com/userfiles/20140624152430161.png">
						</div>
						<div class="one">
							<div>
