                            ...
                            <div class="box1 text-center">
                                 <form class="search-form domain-search">
                                    ...
                                    <div class="three-fifth column first">
                                        <input type="text" class="text" value="请输入商标名称，如：国标商标" onFocus="this.value = '';" onBlur="if (this.value == '') {this.value = '请输入商标名称，如：国标商标';}">               
                                     </div>
                                     <div class="one-fifth column">
                                        <a class="popup-with-zoom-anim search-btn" href="#search-dialog">免费查询</a>
                                     </div>
                                 </form>
                           </div>
                        </div>
