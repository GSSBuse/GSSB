		...
		<div class="container">
			<div class="row">
				...
				<div style="width:800px; margin:0 auto;">
					...
					<h2 style="text-align: center; margin-top: 10px;">授权需要的条件</h2>
					<div
					...
					<div>
						...
						<p>
							<span
								style="color: rgb(51, 51, 51); font-family: 微软雅黑, 宋体; font-size: 14px; line-height: 25px;">根据《专利法》第二十二条的规定，授予专利权的发明和实用新型，应当具备新颖性、创造性和实用性。</span><br
								style="margin: 0px; padding: 0px; font-family: 微软雅黑, 宋体; color: rgb(51, 51, 51); font-size: 14px; line-height: 25px;">
							<span
								style="color: rgb(51, 51, 51); font-family: 微软雅黑, 宋体; font-size: 14px; line-height: 25px;">
								新颖性，是指该发明或者实用新型不属于现有技术；也没有任何单位或者个人就同样的发明或者实用新型在申请日以前向国务院专利行政部门提出过申请，并记载在申请日以后公布的专利申请文件或者公告的专利文件中。</span><br
								style="margin: 0px; padding: 0px; font-family: 微软雅黑, 宋体; color: rgb(51, 51, 51); font-size: 14px; line-height: 25px;">
							<span
								style="color: rgb(51, 51, 51); font-family: 微软雅黑, 宋体; font-size: 14px; line-height: 25px;">
								创造性，是指与现有技术相比，该发明具有突出的实质性特点和显著的进步，该实用新型具有实质性特点和进步。</span><br
								style="margin: 0px; padding: 0px; font-family: 微软雅黑, 宋体; color: rgb(51, 51, 51); font-size: 14px; line-height: 25px;">
							<span
								style="color: rgb(51, 51, 51); font-family: 微软雅黑, 宋体; font-size: 14px; line-height: 25px;">
								实用性，是指该发明或者实用新型能够制造或者使用，并且能够产生积极效果。</span><br
								style="margin: 0px; padding: 0px; font-family: 微软雅黑, 宋体; color: rgb(51, 51, 51); font-size: 14px; line-height: 25px;">
							<span
								style="color: rgb(51, 51, 51); font-family: 微软雅黑, 宋体; font-size: 14px; line-height: 25px;">
								本法所称现有技术，是指申请日以前在国内外为公众所知的技术。</span><br
								style="margin: 0px; padding: 0px; font-family: 微软雅黑, 宋体; color: rgb(51, 51, 51); font-size: 14px; line-height: 25px;">
							<span
								style="color: rgb(51, 51, 51); font-family: 微软雅黑, 宋体; font-size: 14px; line-height: 25px;">
								根据《专利法》第二十三条的规定，授予专利权的外观设计，应当不属于现有设计；也没有任何单位或者个人就同样的外观设计在申请日以前向国务院专利行政部门提出过申请，并记载在申请日以后公告的专利文件中。</span><br
								style="margin: 0px; padding: 0px; font-family: 微软雅黑, 宋体; color: rgb(51, 51, 51); font-size: 14px; line-height: 25px;">
							<span
								style="color: rgb(51, 51, 51); font-family: 微软雅黑, 宋体; font-size: 14px; line-height: 25px;">
								授予专利权的外观设计与现有设计或者现有设计特征的组合相比，应当具有明显区别。</span><br
								style="margin: 0px; padding: 0px; font-family: 微软雅黑, 宋体; color: rgb(51, 51, 51); font-size: 14px; line-height: 25px;">
							<span
								style="color: rgb(51, 51, 51); font-family: 微软雅黑, 宋体; font-size: 14px; line-height: 25px;">
								授予专利权的外观设计不得与他人在申请日以前已经取得的合法权利相冲突。</span><br
								style="margin: 0px; padding: 0px; font-family: 微软雅黑, 宋体; color: rgb(51, 51, 51); font-size: 14px; line-height: 25px;">
							<span
								style="color: rgb(51, 51, 51); font-family: 微软雅黑, 宋体; font-size: 14px; line-height: 25px;">
								本法所称现有设计，是指申请日以前在国内外为公众所知的设计。</span>
						</p>
						<p></p>
					</div>
				</div>
