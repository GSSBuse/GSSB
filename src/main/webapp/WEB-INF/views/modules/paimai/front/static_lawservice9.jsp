					...
					<div class="menuB">
						<div class="one" style="display: block;">
							<article>
								...
								<h2>什么是证明商标？</h2>
								<p>《商标法》第三条对证明商标的定义：“本法所称证明商标，是指由对某种商品或者服务具有监督
									能力的组织所控制，而由该组织以外的单位或者个人使用于其商品或者服务，用以证明该商品或者
									服务的原产地、原料、制造方法、质量或者其他特定品质的标志。”</p>
								<h2>证明商标必要性:</h2>
								<span class="ll1">01</span>注册证明商标可以保护名优、特色商品名称，否则此类商品名称滥用，失去了原有的品质特色，将使商品特色削弱殆尽，使宝贵的地区特色商品财富受到损失。<br>
								<br> <span class="ll1">02</span>注册证明商标后，由具有监控能力的组织统一管理名优特色产品品牌，将之置于法律保护之下，使经
								营者、生产者能够按照规定的条件生产商品，保证商品特定品质，使证明商标能够依法、合理使用，
								这是法制建设的需要，也是市场经济建设发展不可缺少的一环。<br> <br> <span
									class="ll1">03</span>重要商标被驳回时，只要有一线希望，大多数当事人都会选择权利用尽进行争取。<br>
