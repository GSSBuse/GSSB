					...
					<div class="menuB">
						<div class="one" style="display: block;">
							<article>
								...
								<h2>单国注册</h2>
								<p>单国注册指直接向各个国家/地区商标主 管机关分别递交注册申请的注册方式， 也称“逐一国家注册”，是国际商标保
									护最常用的一种方式，是与一些国际性 或区域性的知识产权保护组织注册方式 相对而言的保护方式。 有的国家采用“使用在先”原则，
									即：最先使用者优先获得商标权，有的 国家采用“申请在先”原则，即：最先 申请者优先获得商标权；各国注册所需
									的时间也差异较大，短的仅需半年左 右，长的则需4-5年；各个国家的商标 有效期、费用和使用要求也各不相同。</p>
								<p>注册特点：逐一国家注册形式最为快捷 便利，注册周期视各国法律和惯例而 定。</p>
								<p class="qo">如在申请过程中出现问题， 可以随时与国外合作方律师事务所 联系，对申请注册的进展情况可以及
									时了解。</p>
								<p>单国商标注册最大的特点就是 权利人可以根据实际需要在任何时候申 请，提交申请时可以改变商标的注册形
									式、修改保护的产品或服务项目，一般 不用受制于国内商标注册的情况，非常 灵活，且都会颁发商标注册证。</p>
								<img
									src="http://www.shangbiaozongju.com/userfiles/20140624152149178.png">
							</article>
						</div>
						<div class="one">
							<img
