				...
				<div class="span8 page-content">
					...
					<div class="menuB">
						<div class="one" style="display: block;">
							<p>根据《商标法》第三十八条：“注册商标有效期满，需要继续使用的，应当在
								期满前六个月内申请续展注册；在此期间未能提出申请的，可以给予六个月的宽展 期。宽展期满仍未提出申请的，注销其注册商标。”</p>
							<article>
								<p>
									<span>&nbsp;及时办理商标续展注册能有效节约时间，重新申请商标的时间长，还可能面临驳回、补证、遭异议等风险，而商标续展注册只需要半年。此外，只有不中断使用、知名度高的注册商标才有资格认定著名商标和驰名商标。
									</span>
								</p>
