				...
				<div class="menuB">
					<div class="one" style="display: block;">
						<article>
							...
							<p>马德里商标国际注册是马德里所有缔约国之间的一种商标国际注册保护方式,它最大
								的特点就是只需要提交一份申请就可以要求在多个缔约国进行注册。</p>
							<p>截止2013年2月，共有89个缔约国。马德里国际注册有国际局统一管理，位于瑞士
								日内瓦，属于世界知识产权组织（WIPO）下辖机构之一。</p>
							<p class="qo">如在申请过程中出现问题， 可以随时与国外合作方律师事务所 联系，对申请注册的进展情况可以及
								时了解。</p>
							<p>更多介绍请见WIPO官网：</p>
							<a href="http://www.wipo.int/portal/index.html.en"><span
								style="color: rgb(0, 0, 255); font-size: 10.5pt; font-family: 微软雅黑;">http://www.wipo.int/portal/index.html.en&nbsp;</span></a>
							<br><a href="http://www.wipo.int/portal/index.html.zh"><span
								style="color: rgb(0, 0, 255); font-size: 10.5pt; font-family: 微软雅黑;">http://www.wipo.int/portal/index.html.zh</span></a>

						</article>
					</div>
					<div class="one">
						<img
							src="http://www.shangbiaozongju.com/userfiles/20140624151901151.png">
					</div>
					<div class="one">
						<div>
