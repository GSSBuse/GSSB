				...
				<div class="menuB">
					<div class="one" style="display: block;">
						<article>
							...
							<h2>什么是争议申请？</h2>
							<p>争议申请是指商标权利人或者利害关系人认为已经注册的商标，违反《商标法》相关规定，请求商标评审委员会撤销该注册商标的法律程序。</p>

							<h2>争议申请必要性:</h2>
							<span class="ll1">01</span>争议申请是防止已注册商标对自身商标造成淡化、弱化、丑化的重要途径。<br> <br>
							<span class="ll1">02</span>争议申请能够有效解决他人通过商标注册的形式损害权利人商标、版权、字号等在先权利。<br>
							<br> <span class="ll1">03</span>争议申请是商标法赋予社会公众对侵犯自身权益的已注册商标所能够采取的最佳法律措施，当事人只有充分行使，才能维护自身利益。<br>

						</article>
					</div>
					<div class="one">
						<img
							src="http://www.shangbiaozongju.com/userfiles/20140629143006103.png">
					</div>
					<div class="one">
