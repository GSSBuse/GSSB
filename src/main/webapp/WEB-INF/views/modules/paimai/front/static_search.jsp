					...
					<div
						...
						<div class="help" style="margin-left: 20px;">
							...
							<ul>
								...
								<br>
								<li><span class="ll1">2</span>国商知识产权提供的商标查询服务的范围仅限于国家商标局已公开的商标数据，不含从查询之日起前八个月内申请的在先权利信息；不含处于评审状态的在先权利信息；不含《中华人民共和国商标法》第10、11条所规定的内容。</li>
								<br>
								<li><span class="ll1">3</span>本公司提供查询结果及建议仅供参考，不能作为商标注册的法律依据。</li>
								<br>
								<li><span class="ll1">4</span>我们将对您的查询内容进行保密，严格保守您的商业秘密。</li>
							</ul>
						</div>
					</div>
				<!-- end of page content -->
