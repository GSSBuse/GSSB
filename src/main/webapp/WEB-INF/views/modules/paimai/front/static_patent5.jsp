					...
					<div class="menuB">
						<div class="one" style="display: block;">
							<article>
								...
								<h2>香港专利</h2>
								<h4>1、香港标准专利</h4>
								<p>香港标准专利必须以中国发明专利或者英国专利或者指定英国的欧洲专利为基础，通过2阶段的手续获得保护期限为自基础申请日起20年。</p>

								<h4>2、香港短期专利和香港外观设计专利</h4>
								<p>香港的短期专利制度是香港独自的制度，与大陆的实用新型专利类似，不同之处在于其保
									护对象包括方法。有效期限为4年，届满前可续展4年。
									香港外观设计专利制度也为香港独自的制度，有效期限为5年，但可以连续续展5次，每次5 年，最长不超过25年。</p>
							</article>
						</div>
						<div class="one">
