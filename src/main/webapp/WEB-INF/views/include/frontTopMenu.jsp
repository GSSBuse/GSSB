...
<div class="top">
	<div class="mainWidth top-notic">
		<div class="top-left f-l">
			<span class="f-l">站内公告：</span> <span class="f-l pic"><a
				href="#">国标商标最新商标发布，年终打5折！</a></span>
		</div>
		<div class="top-right f-r">
			...
			<c:choose>
				<c:when test="${!empty login_user.username}">
					...
					| <span><a class="icenter"
						href="${ctx }/personalcenter.html?id=${login_user.id}">个人中心</a></span>
	...
	<header>
		<div class="container">
			<div class="logo-container">
				<!-- Website Logo -->
				<img style="width: 30%;" src="${ctxStatic }/images/logo.png"
					align="left">
			</div>
...
<div class="main-im">
	...
	<div class="im_main" id="im_main">
		...
		<a href="http://wpa.qq.com/msgrd?v=3&uin=4005958&site=qq&menu=yes"
			target="_blank" class="im-qq qq-a" title="在线QQ客服">
			<div class="qq-container"></div>
			<div class="qq-hover-c">
				<img class="img-qq" src="${ctxStatic }/images/qq.png">
	...
	<div class="form-box fr loginV2" style="display: block;">
		...
		<div class="form-con">
			...
			<div class="login-normal" style="display: block;">
				<form id="nameLoginForm" method="post" autocomplete="off"
					onsubmit="return nameLoginCheck();">
					...
					<dl class="clearfix">
						<dt>手机号：</dt>
						<dd>
							<input type="text" name="loginName" id="normalUser"
								class="input-text" autocomplete="off" /><span
								class="placeholder">请输入注册手机号</span>
						</dd>
					</dl>
					<dl class="top1 clearfix">
						...
						<dd>
							<input type="password" name="password" id="normalPassword"
								class="input-text"><span class="placeholder">请输入密码</span>
						</dd>
					</dl>

					<div class="form-remember">

						<input name="rememberName" type="checkbox" id="remUser"
							class="rem-check" style="display: none;" checked="checked">
						<span class="rem-box rem-box-r memCheck"><input
							name="rememberMe" type="checkbox" id="remLogin" class="rem-check">三个月之内免登录</span>
					</div>
					<div class="btn-box clearfix">
						<input id="normalSubmit" class="btn-settlement" type=submit
							value="登    录">

					</div>
					<div class="link-box clearfix">
						<a href="javascript:;" class="register">新用户注册</a> <a
							href="javascript:;" class="forget-pass">忘记密码？</a>
					</div>
				</form>
				<div class="login-short clearfix">
					<div class="short-left">
						...
						<ul class="clearfix">
							...
							<li class="sina"><a href="#"
								onclick="javascript:alert('TODO')"></a></li>
					...
					<div class="short-right">
						...
						<p class="phone-short clearfix">
							<i class="phone"></i> <a href="javascript:;"
								class="txt phoneLogin">手机快捷登录</a>
						</p>
					</div>
				</div>
			</div>
		...
		<div class="form-con">
			<form id="mobileLoginForm" method="post"
				...
				<dl class="clearfix">
					<dt>手机号：</dt>
					<dd>
						<input name="mobile" type="text" id="partnerPhone"
							autocomplete="off" class="input-text mobile" maxlength="11"
							onblur="mobileCheck(this);"><span class="placeholder">请输入手机号</span>
					</dd>
				</dl>
				<dl class="top1 clearfix">
					<dt>验证码：</dt>
					<dd>
						<input name="smsCaptcha" type="text" id="partnerYzm"
							class="input-yzm" onblur="captchCheck(this);" maxlength="4"
							autocomplete="off" /> <span class="span-yzm"> <img
							id="smsCaptchaImage" src="${ctxStatic }/images/code.jpg"
							title="点击图片刷新校验码" alt="点击图片刷新校验码"
							onclick="changeCode('smsCaptchaImage','partnerYzm');" /> <a
				...
				<dl class="top2 clearfix">
					<dt>校验码：</dt>
					<dd>
						<input name="code" type="text" id="partnerJym" class="input-jym"
							maxlength="6" autocomplete="off" /> <a id="smsSendButton"
							href="javascript:sendSms(this);" class="span-jym disabled">发送短信校验码</a>
					</dd>
				</dl>
				<div class="form-remember">
					...
					<input name="rememberName" type="checkbox" id="remUser"
						class="rem-check" style="display: none;" checked="checked">
					<span class="rem-box rem-box-r"><input name="rememberMe"
						type="checkbox" id="remLogin" class="rem-check">三个月之内免登录</span>
				</div>
				<div class="btn-box clearfix">
					<input id="partnerSubmit" class="btn-settlement" type="submit"
						value="登    录">
		...
		<div class="form-con">
			<form id="registerForm" method="post"
				...
				<dl class="clearfix">
					<dt>手机号：</dt>
					<dd>
						<input type="text" name="mobile" id="nomalMobile"
							autocomplete="off" class="input-text mobile" maxlength="11"
							onblur="mobileCheck(this);"><span class="placeholder">请输入手机号</span>
					</dd>
				</dl>
				...
				<dl class="top1 clearfix">
					...
					<dd>
						<input type="password" name="password" id="normalPassword"
							class="input-text"><span class="placeholder">密码由6-16位字符组成</span>
					</dd>
				</dl>
				<dl class="top1 clearfix">
					<dt>
					...
					<dd>
						<input type="password" name="rePassword" id="reNormalPassword"
							class="input-text"><span class="placeholder">请再次输入密码</span>
					</dd>
				</dl>
				<dl class="top1 clearfix">
					<dt>验证码：</dt>
				...
				<div class="form-remember">
					<span class="rem-box" onclick="iagreeChange(this);"><input
						type="checkbox" name="iagree" id="iagree" class="rem-check"
						checked="checked" />我已阅读并且同意国商局的<a href="#" class="forget-pass"
