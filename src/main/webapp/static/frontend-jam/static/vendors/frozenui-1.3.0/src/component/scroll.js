...
function Scroll(el, options) {
	...
	if (this.options.role === 'slider') {
		...
		this.scroller = $(this.wrapper).find('.ui-slider-content')[0];
		...
		if (this.options.indicator) {
			...
			this.indicator = $(this.wrapper).find('.ui-slider-indicators')[0];
		}
	}
	...
	// ==================================
		...
		this.scroller = $(this.wrapper).find('.ui-tab-content')[0];
		this.nav = $(this.wrapper).find('.ui-tab-nav')[0];
