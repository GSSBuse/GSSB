...
(function (){
	...
	if ( typeof define === "function" && define.amd ) {
		define(["jquery"], function($) {
			 ...
			 * @param message 显示信息
			 * @param type 默认inverse; inverse||info||success||warning||danger
			 * @param align 默认right; left||center||right
			 * @param from 默认top; top||bottom
			 */
			factory($,window,document);
			
			return function (message, type, align, from) {
				$.growl({
					message: message
				},{
